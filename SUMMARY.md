...
* [Getting it to Work](installation.md)
   * [Installing from precompiled binary packages](installation-packages.md)
   * [Installing from source](installation-source.md)
       * [Requirements to install on Linux](requirements-linux.md)
       * [Installing from source on Linux](installation-linux.md)
       * [Requirements to install on Windows](requirements-windows.md)
       * [Installing from source on Windows](installation-windows.md)
