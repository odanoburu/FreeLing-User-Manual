...
* [Getting it to Work](installation.md)
   * [Installing from precompiled binary packages](installation/installation-packages.md)
   * [Installing from source](installation/installation-source.md)
       * [Requirements to install on Linux](installation/requirements-linux.md)
   ...
   * Calling FreeLing from langiages other than C++
       * [Building and using APIs on Linux](apis-linux.md)
       * [Building and using APIs on Windows](apis-windows.md)
